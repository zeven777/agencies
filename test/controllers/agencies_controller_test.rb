...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { cabina: @agency.cabina, iata: @agency.iata, month: @agency.month, name: @agency.name, negocio: @agency.negocio, revenue: @agency.revenue, year: @agency.year }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { cabina: @agency.cabina, iata: @agency.iata, month: @agency.month, name: @agency.name, negocio: @agency.negocio, revenue: @agency.revenue, year: @agency.year }
    assert_redirected_to agency_path(assigns(:agency))
  end
